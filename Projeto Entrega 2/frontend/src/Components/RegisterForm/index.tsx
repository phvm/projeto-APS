...
const RegisterForm = () => {
    return (
        <Box sx={{boxSizing: 'border-box', width: '80%', height: '80%', backgroundColor: '#F2F0F0', borderRadius: '35px', padding: '1% 7%', display: 'flex', flexDirection: 'column', justifyContent: 'space-evenly'}}>
            ...
            <Box sx={{ width: '100%', height: '40%', display: 'flex', flexDirection: 'column', justifyContent: 'space-around', alignItems: 'center'}}>
                ...
                <Button variant="contained" sx={{backgroundColor: '#E63462', fontSize: '1.2rem',fontWeight: '520' , width: '40%'}}>Registrar</Button>
            </Box>
            <Box>
                <Typography variant="h5" align='center'>
                    Se você já é cadastrado <br/>
                    <a href={Links.Login} style={{color: '#E63462'}}>clique aqui!</a>
                </Typography>
            </Box>
        </Box>
    );
