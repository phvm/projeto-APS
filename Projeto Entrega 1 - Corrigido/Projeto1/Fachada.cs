...
namespace Projeto1
{
    public class Fachada
    {
        ...
        public Fachada(AbstractFactory factory)
        {
            IContaRepositorio contaRepositorio = factory.CreateContaRepositorio();
            IPontoRepositorio pontoRepositorio = factory.CreatePontoRepositorio();
            IAgendamentoRepositorio agendamentoRepositorio = factory.CreateAgendamentoRepositorio();
            IVacinaRepositorio vacinaRepositorio = factory.CreateVacinaRepositorio();
            ...
            var cadastroVacina = new CadastroVacina(vacinaRepositorio);
            ...
            _controlTelaAgendamento = new ControlTelaAgendamento(cadastroAgendamento,cadastroConta, cadastroPonto, cadastroVacina);
